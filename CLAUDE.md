...
- **localStorage keys** (all `-v1`, in `lib/store.js`): `jwh-auth-v1`, `jwh-events-v1`, `jwh-due-v1`, `jwh-notif-dismissed-v1`, `jwh-checklist-v1`, `jwh-theme`, `jwh-brew-notes-v1`, `jwh-brew-ideas-v1`. Bump the `-v1` suffix if a stored shape changes.
