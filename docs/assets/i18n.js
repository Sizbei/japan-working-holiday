...
export const STRINGS = {
  ...
  'lede.packing': 'カナダから東京への引っ越し用の持ち物リスト。書類、お金、電子機器、衣類、健康、初日バッグなどをカテゴリ別に。自分の項目も追加でき、進捗はこの端末に保存されます。',
  'lede.budget': '一年分の初期費用と毎月の生活費を見積もり、貯金額と収入（あれば）を入力すると、着地までに必要な総額・毎月の支出・収支・貯金が何か月もつか（ランウェイ）がわかります。実支出の記録ではなく、編集できる見積りのプランナーです。数値はこの端末に保存されます。',
  'lede.phrases': 'ワーホリ生活のためのサバイバル日本語。コンビニ、区役所の手続き、部屋探し、飲食店、交通、緊急時、日常会話のフレーズを、日本語・読み方・英訳付きでカテゴリ別にまとめています。覚えたいフレーズは★で固定でき、この端末に保存されます。',
