...
export const ROUTES = ['dashboard', 'calendar', 'going', 'deadlines', 'checklist', 'packing', 'budget', 'explore', 'rooms', 'map', 'plan'];
...
const TITLES = {
  ...
  packing: 'Packing', budget: 'Budget', explore: 'Explore', rooms: 'Rooms', map: 'Map', plan: 'Plan a Day',
};
