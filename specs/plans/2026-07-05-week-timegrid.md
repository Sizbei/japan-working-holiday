...
- [x] **WG1** Data + editor. Add optional Start/End time to the event editor (row2), save `time`/`endTime`
...
- [x] **WG2** Desktop grid. Split week events: multi-day → bars (band), single-day untimed → chips
...
- [x] **WG3** Wiring. Click block → openSidePanel; click an empty hour cell → openModal prefilled
